...
<pre class="mermaid" style="display: flex; justify-content: center; margin: 80px 0; background: transparent; border: none; transform: scale(1.4); transform-origin: center;">
sequenceDiagram
